...
<b>Case 1 examples</b>
 ...
 1) T(n) = 2T(n/2) + n 
	...
	Time complexity is : <b>O(n<sup>1</sup>(logn)<sup>0+1</sup>) = O(nlogn)</b> <i>//as (log<sub>2</sub>2 = 1)</i>

 2) T(n) = 4T(n/2) + n<sup>2</sup>

	a = 4, b = 2, k = 2 and p = 0  <i>//No log component in second term, so p is 0.</i><br>
	Time complexity is : <b><b>O(n<sup>2</sup>(logn)<sup>0+1</sup>) = O(n<sup>2</sup>logn)</b> 
