...
---------------------------
Insertion sort, takes time roughly equal to c1*n<sup>2</sup>2 to sort n items, where c1 is a constant that does not depend on n. That is, it takes time roughly proportional to n<sup>2</sup> . 
