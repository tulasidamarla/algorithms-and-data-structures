...
<i><ins>Answer</ins></i>
The time complexity of the problem is O(n*n*n*n).i.e. n<sup>4</sup>.
...
So, for a given n value Total no of iterations of while loop is (n+1). Outer for loop executes k times. so total time is k*(n+1). i.e. 2<sup>2</sup>2<sup>2</sup>n(n+1)
	
<i><ins>Answer</ins></i>
The time complexity of the problem is O(2<sup>2</sup>2<sup>2</sup>n(n+1))
