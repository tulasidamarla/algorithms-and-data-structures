...
- To imagine tree from an array, tree elements have to be given indexes.
- If a tree contains
- Tree index start with root as index 0(lets say root value is 10). This is called level 0. 
